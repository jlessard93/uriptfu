...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-145552503-1"></script>
    <script>
        ...
        gtag('config', 'UA-145552503-1');
    </script>

    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/>
    <title>URI PTFU</title>
    <link href="css/bootstrap.css" rel="stylesheet">
    <link href="css/simple-sidebar.css" rel="stylesheet">
    <link rel="stylesheet" href="css/font-awesome.css">
    <link rel="shortcut icon" href="images/ptfulogo_rev(fav).ico">
</head>
